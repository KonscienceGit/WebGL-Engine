class GameBindingsDefinitions extends BindingGroup{
    ...
    initActions() {
        ...
        validateMenuAction.addInput(this._gamepadManager.createInput(XboxGamePadInputs.BUTTON_A, validateMenuAction.getType()));
        validateMenuAction.addInput(this._keyboardManager.createInput(US_Keyboard.Space, validateMenuAction.getType()));
        validateMenuAction.addInput(this._keyboardManager.createInput(US_Keyboard.Enter, validateMenuAction.getType()));
        ...
        returnToMainMenuAction.addInput(this._gamepadManager.createInput(XboxGamePadInputs.BUTTON_START, returnToMainMenuAction.getType()));
        returnToMainMenuAction.addInput(this._keyboardManager.createInput(US_Keyboard.Escape, returnToMainMenuAction.getType()));
        ...
        fireShipAction.addInput(this._gamepadManager.createInput(XboxGamePadInputs.BUTTON_A, fireShipAction.getType()));
        fireShipAction.addInput(this._keyboardManager.createInput(US_Keyboard.Space, validateMenuAction.getType()));
        ...
        moveShipLeftAction.addInput(this._gamepadManager.createInput(XboxGamePadInputs.BUTTON_CROSS_LEFT, moveShipLeftAction.getType()));
        moveShipLeftAction.addInput(this._gamepadManager.createInput(XboxGamePadInputs.AXIS_LEFTAXIS_LEFT, moveShipLeftAction.getType()));
        moveShipLeftAction.addInput(this._keyboardManager.createInput(US_Keyboard.ArrowLeft, moveShipLeftAction.getType()));
        ...
        moveShipRightAction.addInput(this._gamepadManager.createInput(XboxGamePadInputs.BUTTON_CROSS_RIGHT, moveShipRightAction.getType()));
        moveShipRightAction.addInput(this._gamepadManager.createInput(XboxGamePadInputs.AXIS_LEFTAXIS_RIGHT, moveShipRightAction.getType()));
        moveShipRightAction.addInput(this._keyboardManager.createInput(US_Keyboard.ArrowRight, moveShipRightAction.getType()));
